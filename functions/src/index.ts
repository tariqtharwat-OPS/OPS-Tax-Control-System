...
export const validatePurchase = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    ...
    if (!supplierDoc.exists) return snap.ref.delete();
...
export const validatePayment = functions.firestore
...
export const validateInventorySource = functions.firestore
...
export const validateTransfer = functions.firestore
